...
class UnlearningTechnique:
    ...
    def retraining(self, model_name , dataset_name,  target_forget_class,  Dr, model, opt_func, learning_rate, number_of_epochs, plot_exp = False ):
        ...
        # torch.save(model.state_dict(), f'./{model_name}_{dataset_name}_epochs={number_of_epochs}_lr={learning_rate}_without class_{target_forget_class}.pth')
        return model
